...
public class GameManagerQuiz : MonoBehaviour {
    ...
    [SerializeField] GameObject GanzesQuizAlla;
    public static bool QuizDoneOnceExit = false;

    [SerializeField] GameObject CodeSchnipsel;
    ...
    void Start()
    {
        ...
        CodeSchnipsel.SetActive(false);
        QuizDoneOnceExit = false;
    ...
    public void QuitGame()
    {
        ...
        //hier rein quit button
        GanzesQuizAlla.SetActive(false);
        QuizDoneOnceExit = true;
